...
func initRsaKeys() error {
	...
	rsa.PublicKeyPath = env.GoDotEnvVariable("RSA_PUBLIC_PATH")
	rsa.PrivateKeyPath = env.GoDotEnvVariable("RSA_PRIVATE_PATH")
	...
	privateKey, err := jwt.ParseRSAPrivateKeyFromPEMWithPassword(privateKeyData, env.GoDotEnvVariable("RSA_PASSWORD"))
	if err != nil {
		log.Error("error public key: ", err)
		return err
	}
